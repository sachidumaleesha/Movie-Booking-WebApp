...
<body>
    ...
    <?php
        ...
        $id = $_GET['updateNowShowingMovieId'];
        ...
        echo "
            <div class='content'>
                <div class='title'>
                    <h2>Update Now Showing Movie &nbsp-&nbsp ".$mName."</h2>
                </div>
                <form action='' class='form-group' method='POST' enctype='multipart/form-data'>
                    ...
                    <div class='input-group'>
                        ...
                        <input type='date' name='endDate' placeholder=".$showEndDate." required>
                    </div>
                    <div class='input-group'>
        ...
        if(isset($_POST['submit'])){
            ...
            if(in_array($fileName_extension1, $extension) && in_array($fileName_extension2, $extension)){
                ...
                $query = "UPDATE `now_showing_movies` SET movieName = '$movieName', movieCategory = '$movieCategory', movieDirector = '$movieDirector', movieWriters = '$movieWriters', movieCast = '$movieCast', movieDuration = '$movieDuration', moviePlot = '$moviePlot', endDate = '$showEndDate', trailerUrl = '$movieUrl', movieImage = '$destination1', bannerImage = '$destination2' WHERE movieID = $id";
