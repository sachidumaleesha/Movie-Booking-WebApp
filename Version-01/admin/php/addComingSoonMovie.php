...
<body>
    ...
    <div class="content">
        ...
        <form action="../phpHandlers/dbh.addComingSoonMovie.php" class="form-group" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="date" name="releaseDate" placeholder="YYYY-MM-DD" required>
            </div>
            <div class="input-group">
